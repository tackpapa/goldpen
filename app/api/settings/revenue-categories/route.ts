...
export async function GET(request: Request) {
  try {
    ...
    if (error) {
      console.error('[RevenueCategories GET] Error:', error)
...
export async function POST(request: Request) {
  try {
    ...
    if (error) {
      ...
      console.error('[RevenueCategories POST] Error:', error)
...
export async function PUT(request: Request) {
  try {
    ...
    if (body.categories && Array.isArray(body.categories)) {
      const updates = body.categories.map((cat, index: number) => ({
        id: cat.id,
        org_id: orgId,
        name: cat.name,
      ...
      for (const update of updates) {
        ...
        if (error) {
          console.error('[RevenueCategories PUT batch] Error:', error)
        }
      }
    ...
    if (error) {
      console.error('[RevenueCategories PUT] Error:', error)
...
export async function DELETE(request: Request) {
  try {
    ...
    if (error) {
      console.error('[RevenueCategories DELETE] Error:', error)
