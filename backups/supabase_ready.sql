-- GoldPen Database Migration for Supabase
-- This file contains the complete database schema and initial data

-- Create ENUM types
CREATE TYPE public.user_role AS ENUM ('owner', 'manager', 'teacher', 'staff', 'student', 'parent');
...
-- Create helper function for getting current user's role
-- NOTE: This function must be created AFTER tables are defined
